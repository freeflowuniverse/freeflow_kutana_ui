    ...
    <div class="settings">
        <v-dialog v-model="verifyLougout" max-width="500">
            <v-card>
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn @click="closeVerifyLougout(false)" text small
                        >No</v-btn
                    >
                    <v-btn
                        @click="closeVerifyLougout(true)"
                        text
                        small
                        color="red"
                        >Yes</v-btn
        ...
        <v-dialog max-width="650" v-model="show" scrollable>
            <v-card>
                ...
                <v-card-text>
                    ...
                    ></v-switch>
                    <h2 class="subtitle-1" v-if="removeBackgroundSupported">
                        Choose background
                    </h2>
